from peach.settings import SchemaDict
...
SCHEMA: list[SchemaDict] = [
    ...
    },
    {
        ...
        "help": "Customize how Peach displays notifications",
        "type": "object",
        "fields": [
            {
                "key": "system",
                "title": "Show Peach notifications on your desktop?",
                "type": "choices",
                "default": "blur",
                "choices": [
                    ("Never", "never"),
    ...
    },
    {
        ...
        "help": "Customize how Peach displays agent tool calls",
        "type": "object",
        "fields": [
            {
                "key": "expand",
                "title": "Tool call expand",
                "help": "When should Peach expand tool calls?",
                "type": "choices",
                "default": "fail",
                "choices": [
                    ("Never", "never"),
        ...
        "fields": [
            {
                ...
                "help": "Disabled by default in Peach. The upstream Toad project used PostHog for anonymous usage stats; Peach does not ship its own analytics endpoint, so this toggle currently has no effect.",
                "type": "boolean",
                "default": False,
            },
        ],
