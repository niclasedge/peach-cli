...
from peach import jsonrpc
import peach
from peach.agent_schema import Agent as AgentData
from peach.agent import AgentBase, AgentReady, AgentFail
from peach.acp import protocol
from peach.acp import api
from peach.acp.api import API
from peach.acp import messages
from peach.acp.prompt import build as build_prompt
from peach.db import DB
from peach import paths
from peach import constants
...
class Agent(AgentBase):
    ...
    def command(self) -> str | None:
        ...
        acp_command = peach.get_os_matrix(self._agent_data["run_command"])
        return acp_command
    ...
    async def rpc_terminal_output(
        ...
        from peach.widgets.terminal_tool import ToolState
    ...
    async def _run_agent(self) -> None:
        ...
        env = os.environ.copy()
        env["PEACH_CWD"] = str(Path("./").absolute())
