...
ABOUT_TEMPLATE = Template(
    """\
# About Peach v${PEACH_VERSION}

Peach is a downstream fork of [Toad](https://github.com/batrachianai/toad)
by Will McGugan, licensed under the terms of the
